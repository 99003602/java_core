...
//		driver.findElement(By.xpath("//*[@id=\"userSignUpForm\"]/div/div/div[1]/ul/li[1]/div/div/ul/li[2]/a")).click();
...
//		driver.findElement(By.id("signupUserContact")).sendKeys("12345678");
		...
		String s=driver.findElement(By.className("captchaContainer")).getText();
